...
export const Hero = () => {
  return (
    <section id="home" className="relative font-sans min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900">
      
      {/* 1. DEFINE THE ANIMATION KEYFRAMES HERE */}
      <style>
        {`
          ...
          /* New keyframes for the better 'Get Started' button hover glow */
      ...
      >
        ...
        <motion.h1
          ...
          className="text-7xl md:text-8xl lg:text-9xl mb-2 tracking-tight"
        >
          <span 
            ...
            // 2. APPLY THE ANIMATION WITH AN INLINE STYLE
        ...
        <motion.div variants={itemVariants}>
          <div className="text-2xl md:text-3xl font-bold text-white mb-4">Season <span className="text-cyan-400">2</span></div>
        </motion.div>

        <motion.div variants={itemVariants}>
          <TypeAnimation
            sequence={[
              'A 3-hour online coding competition where individual programmers test their skills, solve challenges, and prove their coding prowess. Organized By Computer Science & Technology Deptartment, And Techtechnique Polytechnic Institute',
              5000,
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <a 
            href="#about" 
            className="
              relative inline-flex items-center font-bold py-4 px-8 rounded-full 
